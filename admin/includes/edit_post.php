...
if(isset($_GET['edit_post_id'])){
   ...
   $edit_post_query = mysqli_query($connection, $edit_query);
...
<div class="form-group">
    ...
    <img width=100 height=50 src="../images/<?php echo $post_image ?>"/> 
    <br/>
...
<?php confirmQuery($edit_post_query);}
?>
    ...
    
{
    ...
    echo "You have successfully added a new post";
}
    */
}
